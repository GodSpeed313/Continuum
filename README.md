...
| M7 — Moltbook governed-agent deployment | 🔄 In progress — ✅ CredentialIntegrity · ✅ LinkRestriction · ✅ IdentityIntegrity v1 · ⏳ ManipulationFlag |

**344 tests passing + 6 xfailed** (deliberate known-gap pins) across parser, validator, trace builder, resolver, Rift pipeline (v0.1 + v0.2), MCP server, dashboard, the v0.2 rulings, and the M7 Moltbook constraints (key isolation, pre-send gate, link provenance, identity consistency).
